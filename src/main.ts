...
class Strawpoll implements StrawpollClass {
    apiKey: string;
    defaults: PollData;
    ...
    async get(pollID: string = ''): Promise<PollResponse> {
    ...
    async make(poll: PollData): Promise<MakeResponse> {
    ...
    async delete(pollID: string = ''): Promise<DeleteResponse> {
